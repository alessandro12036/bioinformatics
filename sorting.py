...
def _merge(l, r):   # Instead of using SelectionSort like I think we did in class, this algorithm 
...
def _partition(array, low, high): # partition always takes as input the whole array, the only thing that changes
...
if __name__ == "__main__":
    ...
    # with a bigger dataset (merge_sort outperforms both bubble_sort and selection_sort)
    time_sorting_functions([bubble_sort, selection_sort, quick_sort, merge_sort], 
                           names=["BubbleSort", "SelectionSort", "QuickSort", "MergeSort"],
